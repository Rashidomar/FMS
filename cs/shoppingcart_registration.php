...
if($session->is_logged_in()) {
    ...
    $id = $_POST['id'];
     ...
     $result = $order->insert_shop_order($date,$Icode,$quentity,$Verified,$Delivered,$id);
    ...
    echo "<a href='RegisterFa.php'><button class='btn btn-warning'>Register Here<button></a>";
    //exit();
