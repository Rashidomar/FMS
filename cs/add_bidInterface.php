...
//Proccessing the form on the same page, from add_bid.php
...
if(isset($_POST['submit'])){
    ...
    $result = $auction->add_bid($Bidder,$Item_code, $Amount, $Date,$confirm,$reject);
...
<div id="Sign-Up">
    <fieldset style="width:50%"><h2><b>Bids</b></h2>
            <form method="POST">
                ...
                <input readonly class="form-control" value="<?php echo $session->user_id;?>" type="text" name="id">
