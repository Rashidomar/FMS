...
require_once "../includes/auction.php";
...
if(isset($_POST['submit'])){
    ...
    $result = $auction->add_list($Item_type,$Id,$Item_name,$Item_code,$Price,$Quantity,$Date,$Location,$Description);
        ...
        <form method="POST">
            <h2 class="text-center"><span class="glyphicon glyphicon-user"></span> Create Auction</h2>
                ...
                <tr>
                    ...
                    value='<?php  echo $session->user_id;?>' class="form-control"></td>
                </tr>
                <tr>
                    <td> Listing Title</td>
                </tr>
                ...
                <tr>
                    <td><input id="insert" type="submit" name="submit" value="Submit Auction" class="btn btn-info"></td>
                </tr>
