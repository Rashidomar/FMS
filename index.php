  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="view/farmshopwelcome.php"><span class="glyphicon glyphicon-log-in"></span> LoginShop</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="view/adminwelcome.php" ><span class="glyphicon glyphicon-log-in"></span> LoginAdmin</a></li>
      </ul>
...
<div id="myCarousel" class="carousel slide" data-interval="6000" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox" style=" width:100%; height:250px !important;">
        ...
        <div class="item">
            <img src="img/1.png" alt="Third Slide" width="100%">
            <div class="carousel-caption">
                <h3>Farm House</h3>
    ...
    <a class="carousel-control right" href="#myCarousel" data-slide="next">
      ...
      <div class="w3-animate-fading"><center><b class="abc-c">Farm Management S</b></center></div></div>
  </h1>
</div>
